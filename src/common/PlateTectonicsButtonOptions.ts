/**
 * PlateTectonicsButtonOptions.ts
 *
...
export const LIGHT_SURFACE_TEXT_FILL = PlateTectonicsColors.controlSurfaceTextColorProperty;

/**
 * Combo-box chrome for panels. Item labels must use {@link LIGHT_SURFACE_TEXT_FILL}, not
 * {@link PlateTectonicsColors.textColorProperty} — that color is for labels on the dark panel fill.
 */
export const PLATE_TECTONICS_COMBO_BOX_OPTIONS = {
  buttonFill: PlateTectonicsColors.controlSurfaceColorProperty,
  listFill: PlateTectonicsColors.controlSurfaceColorProperty,
  buttonStroke: PlateTectonicsColors.panelBorderColorProperty,
  listStroke: PlateTectonicsColors.panelBorderColorProperty,
...
export const TIME_CONTROL_SPEED_RADIO_OPTIONS = {
  speedRadioButtonGroupOptions: {
    labelOptions: { fill: PlateTectonicsColors.textColorProperty },
  },
